...
def _safe_parser():
    """Create an lxml parser that blocks external entities and network access."""
...
class BaseSchemaValidator:
    ...
    def validate_xml(self):
        ...
        for xml_file in self.xml_files:
            try:
                ...
                lxml.etree.parse(str(xml_file), _safe_parser())
    ...
    def validate_namespaces(self):
        ...
        for xml_file in self.xml_files:
            try:
                root = lxml.etree.parse(str(xml_file), _safe_parser()).getroot()
    ...
    def validate_file_references(self):
        ...
        for rels_file in rels_files:
            try:
                ...
                rels_root = lxml.etree.parse(str(rels_file), _safe_parser()).getroot()
    ...
    def validate_all_relationship_ids(self):
        ...
        for xml_file in self.xml_files:
            ...
            try:
                ...
                xml_root = lxml.etree.parse(str(xml_file), _safe_parser()).getroot()
    ...
    def validate_content_types(self):
        ...
        try:
            ...
            root = lxml.etree.parse(str(content_types_file), _safe_parser()).getroot()
            declared_parts = set()
            ...
            for xml_file in self.xml_files:
                ...
                try:
                    root_tag = lxml.etree.parse(str(xml_file), _safe_parser()).getroot().tag
    ...
    def _validate_single_file_xsd(self, xml_file, base_path):
        ...
        try:
            ...
            # Load and preprocess XML with safe parser
            with open(xml_file, "r") as f:
                xml_doc = lxml.etree.parse(f, _safe_parser())
    ...
    def _get_original_file_errors(self, xml_file):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Extract original file with zip-slip protection
            with zipfile.ZipFile(self.original_file, "r") as zip_ref:
                real_temp = os.path.realpath(str(temp_path))
